...
# 将来的に
cas番号検索すらも面倒なのでgoogle search APIか生成AI系APIを入れてみてもいいかもしれない
* google search APIは無料枠がシビア100query/day
* Open AI APIは無料枠がない
* Geminiは無料枠あるしまあまあ有能かも 使うならコイツかなあ
<br>
とはいえLLMごときに廃液処理を背負わせるのは癪だしやらかさないかのダブルチェックとかどうすんのと思うのでどうしようかな～というかんじ 自動運転の車が事故ったらどうするのか問題が卑近なところまで下りてきた感じがしておもろい<br>
# この倫理問題に決着がついたら起こして それに従って開発するから
